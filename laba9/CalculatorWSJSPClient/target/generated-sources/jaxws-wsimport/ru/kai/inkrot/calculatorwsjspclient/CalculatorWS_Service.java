 ...
 * 
 */
@WebServiceClient(name = "CalculatorWS", targetNamespace = "http://laba9.inkrot.kai.ru/", wsdlLocation = "http://localhost:8080/CalculatorWS/CalculatorWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORWS_QNAME = new QName("http://laba9.inkrot.kai.ru/", "CalculatorWS");
    ...
    public CalculatorWS getCalculatorWSPort() {
        return super.getPort(new QName("http://laba9.inkrot.kai.ru/", "CalculatorWSPort"), CalculatorWS.class);
    }
    ...
    public CalculatorWS getCalculatorWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://laba9.inkrot.kai.ru/", "CalculatorWSPort"), CalculatorWS.class, features);
    }
